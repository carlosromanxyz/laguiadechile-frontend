...
export function LDCHeader() {
  return (
    <header className="sticky top-0 z-50 w-full px-4 py-4">
      ...
      <div className="container mx-auto max-w-7xl rounded-full border border-border/40 bg-white/40 backdrop-blur-md supports-[backdrop-filter]:bg-white/30 dark:bg-black/40 dark:supports-[backdrop-filter]:bg-black/30 shadow-lg">
