  ...
  return (
    <Link
      ...
      className={cn(
        ...
        "hover:text-pink dark:hover:text-yellow hover:bg-black/5 dark:hover:bg-white/5",
        isActive ? "text-pink dark:text-yellow bg-black/5 dark:bg-white/5" : "text-black dark:text-white",
        className
      )}
    >
      {label}
