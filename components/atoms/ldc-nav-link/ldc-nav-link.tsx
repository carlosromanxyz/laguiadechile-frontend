  ...
  return (
    <Link
      ...
      className={cn(
        ...
        "hover:text-pink dark:hover:text-yellow hover:bg-black/10 dark:hover:bg-white/10",
        isActive ? "text-pink dark:text-yellow bg-black/10 dark:bg-white/10" : "text-black dark:text-white",
        className
      )}
    >
      {label}
